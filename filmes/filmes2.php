        ...
        <div class="col-6 sm-8 text-left">
          <div class="w-100 p-3">
            <div class="w-100 p-3 " style="background-color: #FEE3E3; opacity: 0.8">
              <h5>Sinopse: </h5>
              <h3>Dois meninos embarcam em um trem com a missão de derrotar um demônio que tem atormentado as pessoas.</div>
            <div class="w-100 p-3 mt-3" style="background-color: #FEE3E3; opacity: 0.8">
              ...
              <div class="card col-6 ml-6" style="width: 250rem;">
                  <div class="card">
                  <h5 class="card-title">03/12 18:00 sala 4</h5>
                    <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" class="btn btn-danger">R$15,00</a>
                </div>
              </div><p>
              <div class="card col-6 ml-6" style="width: 250rem;">
                  <div class="card">
                  <h5 class="card-title">04/12 18:00 sala 4</h5>
                    <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" class="btn btn-danger">R$15,00</a>
                </div>
              </div><p>
              <div class="card col-6 ml-6" style="width: 250rem;">
                  <div class="card">
                  <h5 class="card-title">05/12 18:00 sala 4</h5>
                    <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" class="btn btn-danger">R$15,00</a>
                </div>
              </div><p>
            </div>
