  ...
  <div class="row content">
    <div class="p-5 col-sm-30 row mt-4" style="background-color: #eee; opacity: 0.9">
      ...
      <div class="card col- sm-6" style="width: 21rem;">
        ...
        <div class="card-body">
          <h6 class="card-title">Natsu e no tunnel</h6>
          <a href="../ingresso.php" class="btn btn-danger">R$10,99</a>
        </div>
      </div>    
        <div class="col-6 sm-8 text-left">
          <div class="w-100 p-3">
            <div class="w-100 p-3 " style="background-color: #FEE3E3; opacity: 0.8">
              <h5>Sinopse: </h5>
              <h3>A história acompanha Tono Kaoru, um jovem que perdeu a irmã em um acidente há cinco anos. Ele ouve um rumor a respeito do “Tunel de Urashima”, um portal mágico que ignora as leias do tempo e espaço e pode conceder qualquer desejo em troca de seu tempo de vida.
            </div>
              ...
              <h5>Sessões disponíveis: </h5>
                <div class="card col-6 ml-6" style="width: 250rem;">
                  ...
                  <h5 class="card-title">22/11 15:30 sala 2</h5>
                    <a href="#" class="btn btn-danger">R$10,99</a>
                </div>
              </div><p>
              <div class="card col-6 ml-6" style="width: 250rem;">
                  <div class="card">
                  <h5 class="card-title">03/12 08:00 sala 1</h5>
                    <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" class="btn btn-danger">R$10,99</a>
                </div>
              </div><p>
              <div class="card col-6 ml-6" style="width: 250rem;">
                  <div class="card">
                  <h5 class="card-title">03/12 14:00 sala 2</h5>
                    <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" class="btn btn-danger">R$10,99</a>
                </div>
              </div><p>
              <div class="card col-6 ml-6" style="width: 250rem;">
                  <div class="card">
                  <h5 class="card-title">04/12 22:00 sala 4</h5>
                    <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" class="btn btn-danger">R$10,99</a>
                </div>
              </div><p>
            </div>
