  ...
  <div class="row content">
    <div class="p-5 col-sm-30 row mt-4" style="background-color: #eee; opacity: 0.9">
      ...
      <div class="card col- sm-6" style="width: 21rem;">
        ...
        <div class="card-body">
          <h6 class="card-title">Ironman</h6>
          <a href="ingresso.php" class="btn btn-danger">R$4,99</a>
        </div>
      </div>    
            ...
            <div class="w-100 p-3 mt-3" style="background-color: #FEE3E3; opacity: 0.8">
              <h5>Sessões disponíveis: </h5>
                <div class="card col-6 ml-6" style="width: 250rem;">
                  <div class="card">
                  <h5 class="card-title">27/11 sala 3 8:00</h5>
                    <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" class="btn btn-danger">R$4,99</a>
                </div>
              </div><p>
              <div class="card col-6 ml-6" style="width: 250rem;">
                  <div class="card">
