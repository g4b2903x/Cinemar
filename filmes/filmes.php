    ...
    <div class="p-5 col-sm-30 row mt-4" style="background-color: #eee; opacity: 0.9">
      ...
      <div class="card col- sm-6" style="width: 21rem;">
        ...
        <div class="card-body">
          ...
          <a href="ingresso.php" class="btn btn-danger">R$15,00</a>
        </div>
      </div>    
        <div class="col-6 sm-8 text-left">
          <div class="w-100 p-3">
            <div class="w-100 p-3 " style="background-color: #FEE3E3; opacity: 0.8">
              <h5>Sinopse: </h5>
              <h3>Mitsuha é a filha do prefeito de uma pequena cidade, mas sonha em tentar a sorte em Tóquio. Taki trabalha em um restaurante em Tóquio e deseja largar o seu emprego. Os dois não se conhecem, mas estão conectados pelas imagens de seus sonhos.<p>
            </div>
              ...
              <h5>Sessões disponíveis: </h5>
                <div class="card col-6 ml-6" style="width: 250rem;">
                  ...
                  <h5 class="card-title">22/11 15:30 sala 2</h5>
                    <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" class="btn btn-danger">R$15,00</a>
                </div>
              </div><p>
              <div class="card col-6 ml-6" style="width: 250rem;">
                  <div class="card">
                  <h5 class="card-title">01/12 18:00 sala 1</h5>
                    <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" class="btn btn-danger">R$15,00</a>
                </div>
              </div><p>
              <div class="card col-6 ml-6" style="width: 250rem;">
                  <div class="card">
                  <h5 class="card-title">02/12 20:00 sala 1</h5>
                    <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" class="btn btn-danger">R$15,00</a>
                </div>
              </div><p>
              <div class="card col-6 ml-6" style="width: 250rem;">
                  <div class="card">
                  <h5 class="card-title">02/12 22:00 sala 2</h5>
                    <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" class="btn btn-danger">R$15,00</a>
                </div>
              </div><p>
            </div>
